...
Acessa o site pelo navegador

Digita o nome da cidade desejada

Realiza a busca

Visualiza as informações climáticas em tempo real

Observa mudanças visuais conforme o clima atual
...
Uso de JavaScript assíncrono (fetch / async/await)

Criação de animações dinâmicas com CSS

Organização do código front-end em pastas
